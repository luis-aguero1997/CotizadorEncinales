...
public class ConsumoElectrico_1 extends javax.swing.JFrame {
    ...
    private void BTN_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_AgregarActionPerformed
        String a = TXT_ConsumoKwEq.getText();
        String b = TXT_HorasConsumo.getText();
        String c = TXT_NombreEquipo.getText();
        
        if (!this.TXT_ConsumoKwEq.getText().isEmpty() || !this.TXT_ConsumoKwEq.getText().equals(null) //Verifica que los campos no esten vacios
                && !this.TXT_HorasConsumo.getText().isEmpty() || !this.TXT_HorasConsumo.getText().equals(null)
                && !this.TXT_NombreEquipo.getText().isEmpty() || !this.TXT_NombreEquipo.getText().equals(null)) {
            if (!this.TXT_ConsumoKwEq.getText().equals("0")
    ...
    private void TXT_NombreEquipoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TXT_NombreEquipoKeyTyped
        ...
        if (TXT_NombreEquipo.getText().length() == 45) {
            evt.consume();
        }
